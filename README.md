# webЯcade Application: Game Boy Advance (GBA) Emulator
...
The underlying emulator is a [forked version](https://github.com/raz0red/gba.ninja/tree/webrcade) of [gba.ninja](https://github.com/raz0red/gba.ninja). Gba.ninja is an Emscripten port of [VisualBoyAdvance-M](https://vba-m.com/).
